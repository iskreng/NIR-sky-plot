...
plt.annotate(cw_setup,xy=(lowlim+.002,1.15),xytext=(lowlim+.002,1.15),fontsize=9)

plt.legend(loc=1,fontsize=9,ncol=2,columnspacing=.5,markerscale=0.28,framealpha=0)
